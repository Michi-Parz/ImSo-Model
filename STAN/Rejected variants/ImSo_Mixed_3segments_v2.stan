...
model {
  ...
  fe_slope2 ~ normal(-5,0.2);
  fe_slope3 ~ normal(-16, 0.4);
  fe_bp1 ~ normal(100, 11);
  fe_bp_diff ~ normal(1000, 61);


  var_int ~ exponential(0.125);
  var_slope1 ~ exponential(1.0/1.3);
  var_slope2 ~ exponential(0.25);
  var_slope3 ~ exponential(0.25);
  var_bp1 ~ exponential(0.1);
