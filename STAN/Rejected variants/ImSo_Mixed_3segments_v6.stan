...
model {
  ...
  var_int ~ exponential(1.0/hyper_v_int);
  var_slope1 ~ exponential(1.0/hyper_v_slope1);
  var_slope2 ~ exponential(1.0/hyper_v_slope2);
  var_slope3 ~ exponential(1.0/hyper_v_slope3);
  var_bp1 ~ exponential(1.0/hyper_v_bp1);
  var_bp_diff ~ exponential(1.0/hyper_v_bp_diff);
